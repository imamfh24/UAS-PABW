...
<form action="" class="mb-5" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="surat_pembimbing_jur_no" value="<?=$result1->surat_pembimbing_jur_no?>"  required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="surat_pembimbing_jur_tgl_surat" value="<?=$result1->surat_pembimbing_jur_tgl_surat?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="surat_pembimbing_jur_tgl_ttd" value="<?=$result1->surat_pembimbing_jur_tgl_ttd?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="surat_pembimbing_jur_file" value="<?=$result1->surat_pembimbing_jur_file?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="surat_pengantar_no" value="<?=$result1->surat_pengantar_no?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="surat_pengantar_tgl_surat" value="<?=$result1->surat_pengantar_tgl_surat?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="surat_pengantar_file" value="<?=$result1->surat_pengantar_file?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="surat_perusahaan_no" value="<?=$result1->surat_perusahaan_no?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="surat_perusahaan_tgl_surat" value="<?=$result1->surat_perusahaan_tgl_surat?>" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="surat_perusahaan_file" value="<?=$result1->surat_perusahaan_file?>" required>
        </div>
    </div>

    <h6>Pembimbing Perusahaan</h6>
    <p>Silahkan tambahkan Pembimbing Perusahaan jika belum tersedia <a href="index.php?modul=Pengajuan&action=perusahaan">Disini</a></p>
    <div class="form-group row">
        <div class="col-sm-10">
