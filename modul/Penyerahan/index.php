...
<form action="" class="mb-5" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="lap_judul" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" name="lap_abstrak" id="" cols="30" rows="5"></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="lap_keywords" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="lap_file_content" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="lap_file_full" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="lap_tgl_perusahaan" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="lap_tgl_perpustakaan" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="lap_tgl_jurusan" required>
        </div>
    </div>
    <hr>
