...
<form action="" class="mb-5" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="sem_judul" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="datetime-local" class="form-control" name="sem_tgl_waktu" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="sem_laporan" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="sem_foto_1_file" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="sem_foto_2_file" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="file" class="form-control" name="sem_foto_3_file" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="sem_nilai_perusahaan" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="sem_nilai_seminar" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="sem_nilai_bimbingan" required>
        </div>
    </div>
